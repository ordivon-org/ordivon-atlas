...
The manual collection currently preserves fourteen high-value 2026-08-18/19 episodes:
...
12. [`episodes/2026-08-19-rsi-pal-option-pressure-deletion-and-capability-topology.md`](episodes/2026-08-19-rsi-pal-option-pressure-deletion-and-capability-topology.md) — delayed-canonicalization continuation of Episode 7 through Option-Space/Pressure theory deletion into an RSI capability topology. It was branch-locally called Episode 10 at `f6bd1a4`; canonical slot 12 avoids renumbering already-current SCD Episode 10 and challengeability Episode 11, and the ordinal is navigation-only rather than event chronology.
13. [`episodes/2026-08-19-computational-possibility-destructive-audit-and-positive-reconstruction.md`](episodes/2026-08-19-computational-possibility-destructive-audit-and-positive-reconstruction.md) — delayed-canonicalization CP re-understanding episode: hostile quantifier/composition/transport/capability audit, derived-calculus materialization, positive reconstruction, consumer dogfoods and later novelty subtraction. The pinned branch called this Episode 10; canonical slot 13 avoids renumbering current slots 10–12. The ordinal is navigation/integration metadata, not semantic identity or event chronology.
14. [`episodes/2026-08-19-cross-owner-coupling-audit-and-shadow-authority-repair.md`](episodes/2026-08-19-cross-owner-coupling-audit-and-shadow-authority-repair.md) — how a proposed horizontal-layer extraction was decomposed into local truth/shared relations/independent programmes/bounded carriers/derived bridges, how two rehome candidates were falsified, and how the sole surviving Shadow Semantic Authority was repaired without a global registry or historical rewrite.
